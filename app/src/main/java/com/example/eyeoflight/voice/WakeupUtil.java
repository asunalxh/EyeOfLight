...
public class WakeupUtil {
    ...
    public static void setOnWakeupResult(OnWakeupResult onWakeupResult) {
        WakeupUtil.onWakeupResult = onWakeupResult;
    }

    public interface OnWakeupResult{
        void onResult();
        void onVolumeChange(int volume);
    }

    private static OnWakeupResult onWakeupResult=null;
    ...
    public static void startListen(){mIvw.startListening(mWakeuperListener);}
    ...
    public static void setUpVoiceWakeuper(){
...
//            mIvw.startListening(mWakeuperListener);
    ...
    private static WakeuperListener mWakeuperListener = new WakeuperListener() {
        ...
        public void onResult(final WakeuperResult result) {
            if(onWakeupResult!=null)
                onWakeupResult.onResult();
        }
        ...
        public void onVolumeChanged(int volume) {
            if(onWakeupResult!=null)
                onWakeupResult.onVolumeChange(volume);
        }
    };
